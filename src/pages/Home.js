    ...
    <div className='w-full'>
      ...
      <div className='md:flex md:flex-row flex-col justify-evenly mt-20 capitalize px-5 md:px-0'>
        {Statistics.map(statistic => 
          <div className='hover:bg-gray-50 border-b-2 md:border-b-0 boder-gray-400 border-solid px-5 h-28 md:px-0 my-5 w-full md:w-44 md:text-center flex justify-between md:flex-col' style={{alignItems: 'center'}}>
            {statistic.icon}
